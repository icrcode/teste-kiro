...
- [x] Implementar `carregar_yaml()` com tratamento de erros de parsing
- [x] Implementar `validar_schema()` com checagem de campos obrigatórios
- [x] Implementar `validar_componentes()` com lista de serviços AWS suportados
- [x] Implementar `validar_conexoes()` com verificação de referências
